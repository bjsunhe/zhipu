...
const url = 'https://open.bigmodel.cn/api/paas/v3/modelapi/chatglm_bosch_demo_0921_2/invoke'; // Replace with your API endpoint URL
...
const axiosConfig = {
    method: 'POST', // Change the method to 'PUT', 'DELETE', etc., if needed
    url: url,
    headers: {
      'Authorization': `Bearer ${token}`, // Replace 'Bearer' with the appropriate authentication scheme if needed
      'Content-Type': 'application/json', // Set the content type based on your API's requirements
    },
    data: requestData, // The data to be sent in the request body
    // You can add other options like 'params', 'timeout', etc.
  };
